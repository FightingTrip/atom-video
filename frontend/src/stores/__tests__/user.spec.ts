...
describe('User Store', () => {
  ...
  it('更新用户信息', async () => {
    ...
    (api.put as any).mockResolvedValue({ data: { ...mockUser, ...updateData } });
  ...
  it('更新用户设置', async () => {
    ...
    (api.put as any).mockResolvedValue({ data: settings });
  ...
  it('获取用户统计信息', async () => {
    const userStore = useUserStore();
    (api.get as any).mockResolvedValue({ data: mockUserStats });
  ...
  it('切换关注状态', async () => {
    const userStore = useUserStore();
    (api.post as any).mockResolvedValue({ data: { isFollowing: true } });
  ...
  it('获取关注列表', async () => {
    const userStore = useUserStore();
    (api.get as any).mockResolvedValue({ data: mockSubscriptions });
  ...
  it('获取粉丝列表', async () => {
    const userStore = useUserStore();
    (api.get as any).mockResolvedValue({ data: mockFollowers });
