    ...
    <div class="auth-card">
      ...
      <div class="auth-footer">
        <p class="signup-prompt">
          没有账号? <router-link to="/auth/register">注册</router-link>
        </p>
      </div>

      <!-- 服务条款和隐私政策 -->
      <div class="terms-privacy">
        <router-link to="/legal/terms" class="terms-link">服务条款</router-link> 和
        <router-link to="/legal/privacy" class="terms-link">隐私政策</router-link>
      </div>
